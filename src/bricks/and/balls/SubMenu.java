 ...
 * @author Threadcount
 */
public class SubMenu extends GameMode {
    ...
    public void draw(Graphics2D grphcs) {
        ...
        grphcs.drawString("Retro", 105, 165);
        grphcs.drawString("Modern", 105, 185);
        ...
        /*else if (this.crrnt == 2) {
            grphcs.drawImage(this.h, 85, 194, null);
        }*/
    ...
    public void select() {
        if (this.crrnt == 0) {
            //Save.init();
            this.MdMngr.setMode(4);
        } else if (this.crrnt == 1) {
            this.MdMngr.setMode(6);
        }/*else if (this.crrnt == 2) {
            System.exit(0);
        }*/
    }
